...
import com.zxit.interceptor.DataObjectDescriptor;
import com.zxit.model.Pagination;
...
public class UtilObject {
    ...
    private static boolean checkCopyAsList(Object value, Type type) {
        ...
        return !(!List.class.isAssignableFrom(rawType) || paramType.getActualTypeArguments().length != 1);
    ...
    private static boolean checkCopyAsMap(Object value, Type type) {
        ...
        Class<?> rawType = (Class<?>) paramType.getRawType();
        return !(!Map.class.isAssignableFrom(rawType) || paramType.getActualTypeArguments().length != 2);
